...
const Header: React.FC<HeaderProps> = ({ onBuyCreditsClick, onAuthClick, onProfileClick, credits }) => {
                ...
                <div className="flex items-center gap-4">
                    ...
                    {loading ? (
                        ...
                        <div className="flex items-center gap-2">
                            <button onClick={onProfileClick} className="px-3 py-1.5 text-sm font-semibold bg-gray-700/50 border border-gray-600/30 text-slate-300 rounded-lg hover:bg-gray-700 transition-colors">
                                Profile
                            </button>
                            ...
                            <button onClick={signOut} className="px-3 py-1.5 text-sm font-semibold bg-red-500/10 border border-red-500/30 text-red-300 rounded-lg hover:bg-red-500/20 transition-colors">
                                Logout
                            </button>
                        </div>
                    ) : (
