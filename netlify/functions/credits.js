...
export default async (req) => {
    ...
    if (req.method === "GET") {
        ...
        return new Response(JSON.stringify({ credits: c }), { status: 200, headers: { "Content-Type": "application/json" } });
    }
    ...
    if (req.method === "POST") {
        ...
        return new Response(JSON.stringify({ ok: true, credits: c }), { status: 200, headers: { "Content-Type": "application/json" } });
    }
